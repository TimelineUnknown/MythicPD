...
public class Badges {
	...
	public enum Badge {
		...
		GAMES_PLAYED_1              ( 20, true ),
		HIGH_SCORE_1                ( 21 ),

		//silver
		NO_MONSTERS_SLAIN           ( 33 ),
		MONSTERS_SLAIN_3            ( 34 ),
		MONSTERS_SLAIN_4            ( 35 ),
		GOLD_COLLECTED_3            ( 36 ),
		GOLD_COLLECTED_4            ( 37 ),
		...
		ITEMS_CRAFTED_5             ( 78 ),
		BOSS_SLAIN_4                ( 79 ),
		ALL_RINGS_IDENTIFIED        ( 80 ),
		ALL_ARTIFACTS_IDENTIFIED    ( 81 ),
		DEATH_FROM_GRIM_TRAP        ( 82 ),
		VICTORY                     ( 83 ),
		BOSS_CHALLENGE_1            ( 84 ),
		BOSS_CHALLENGE_2            ( 85 ),
		GAMES_PLAYED_3              ( 86, true ),
		HIGH_SCORE_3                ( 87 ),
