...
public enum Talent {
	...
	//Tengu T1
	FOCUSING_MEAL(128), REFINE_MEMORY(129), KNOWLEDGE_IS_FOCUS(130), MASTERY_OF_AIM(131),
	//Tengu T2
	...
	//Tengu Bombs T4
	EVADING_TOSS(145, 4), FOCUSING_TOSS(146, 4), ENERGETIC_TOSS(147, 4),
	//Smoke Screen T4
	IMPOWERING_MIST(148, 4), CLEARING_MIST(149, 4), LARGER_MIST(150, 4),
	//Escape Route T4
	SAFE_ESCAPE(151, 4), OBSCAVATING_ESCAPE(152, 4), EXHAUSTING_ESCAPE(153, 4),
